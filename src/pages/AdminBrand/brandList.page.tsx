...
const BrandPage = () => {
    ...
    return (<>
        <div className="my-5 border-b border-spacing-10 border-gray-700 flex justify-between">
            ...
            <PrimaryBtn value="Add Brand" href="/admin/brand/create" iconName="ri-plus-line"/>
        </div>
                            ...
                            brand ? <>
                            {
                                brand.map((row: any, indx: number) => (
                                    <Table.Row key={indx} className="bg-white dark:border-gray-700 dark:bg-gray-800">
                                        ...
                                        <Table.Cell>
                                            <Badge color={row.isFeatured ? "gray" : "warning"} size={"sm"}>
                                        ...
                                        <Table.Cell>
                                            <img src={import.meta.env.VITE_IMAGE_URL+'Brand/'+row.logo} className="max-w-24"/>
                                        </Table.Cell>
