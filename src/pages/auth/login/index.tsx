			...
			<section className="grid grid-cols-1 gap-6 lg:grid-cols-12">
				<div className="w-full col-span-1 p-4 mx-auto mt-6 lg:col-span-4 md:p-12 sm:w-2/4 lg:w-full">
					...
					<form onSubmit={handleSubmit(LoginAction)} className="p-4 space-y-4">
						...
						<button type="submit" className="inline-flex h-12 items-center rounded-full bg-gray-900 px-8 text-sm font-semibold text-white transition duration-200 hover:bg-gray-300 hover:text-black focus:ring-4 focus:ring-gray-200 m-2">Login</button>
					</form>
